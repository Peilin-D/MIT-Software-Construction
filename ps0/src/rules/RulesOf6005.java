...
public class RulesOf6005 {
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
        ...
        if (!implementationRequired && (writtenByYourself || (availableToOthers && citingYourSource) || writtenAsCourseWork)) { // code not required to implement
        	return true;
        } else if (implementationRequired && writtenByYourself) { // specifically required
        	return true;
        }
        return false;
